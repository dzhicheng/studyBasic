 ...
 *      非线程安全
 *      允许null值
 *      添加值得时候会先获取对象的hashCode方法，如果hashCode方法返回的值一致，再调用equals方法判断是否一致，
 *      如果不一致才add元素
 *
 **/
public class HashSetSource<E> extends AbstractSet<E>
   implements Set<E>, Cloneable, java.io.Serializable {
         ...
         *  如果此 set 没有包含满足(e==null ? e2==null : e.equals(e2))的元素e2，则向此set 添加指定的元素e
